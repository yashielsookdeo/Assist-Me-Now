...
class AdminProcessedRequestsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_admin_processed_requests)
    ...
    inner class RequestsAdapter(private val requests: List<Models.FinalRequests>) : RecyclerView.Adapter<RequestsAdapter.ViewHolder>() {
        ...
        override fun onCreateViewHolder(
            ...
            val view = LayoutInflater.from(parent.context).inflate(R.layout.recycler_processed_requests, parent, false)
        ...
        override fun onBindViewHolder(holder: RequestsAdapter.ViewHolder, position: Int) {
            ...
            holder.itemView.findViewById<TextView>(R.id.recycler_pr_t).text = text
            holder.itemView.findViewById<Button>(R.id.recycler_pr_item_b_remove).setOnClickListener {
