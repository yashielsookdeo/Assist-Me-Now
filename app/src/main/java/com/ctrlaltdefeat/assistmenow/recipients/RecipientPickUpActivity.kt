...
class RecipientPickUpActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun processLocation(location: Location) {
        ...
        gMap.clear()
        gMap.addMarker(MarkerOptions().position(currentLatLng).title("Pick Up Location"))
    ...
    private fun initButtons() {
        ...
        buttonPickUp = findViewById(R.id.b_addpickup)

        buttonBack.setOnClickListener {
            Request.setPickUp(0.0, 0.0)
        ...
        buttonPickUp.setOnClickListener {
            Request.setPickUp(currentLong, currentLat)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_recipient_pick_up)
